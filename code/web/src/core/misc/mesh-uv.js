    ...
    static trialCompensation(mesh) {
        ...
        function _applyBoxUV(geom, transformMatrix, bbox, bbox_max_size) {
            ...
            if (geom.attributes.uv === undefined) {
                geom.setAttribute('uv', new XThree.Float32BufferAttribute(coords, 2));
            }
            ...
            let makeUVs = function(v0, v1, v2) {
                ...
                let uv0 = new XThree.Vector2();
                let uv1 = new XThree.Vector2();
                let uv2 = new XThree.Vector2();
            ...
            if (geom.index) { // is it indexed buffer geometry?
                for (let vi = 0; vi < geom.index.array.length; vi += 3) {
                    ...
                    let v0 = new XThree.Vector3(vx0, vy0, vz0);
                    let v1 = new XThree.Vector3(vx1, vy1, vz1);
                    let v2 = new XThree.Vector3(vx2, vy2, vz2);
        ...
        function applyBoxUV(bufferGeometry, transformMatrix, boxSize) {
            if (transformMatrix === undefined) {
                transformMatrix = new XThree.Matrix4();
            }
            ...
            const uvBbox = new XThree.Box3(
                new XThree.Vector3(-boxSize / 2, -boxSize / 2, -boxSize / 2), 
                new XThree.Vector3(boxSize / 2, boxSize / 2, boxSize / 2));
