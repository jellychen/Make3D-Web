        ...
        //
            ...
            if (this.isOper_SelectCurve) {
                if (isInteger(this.selected)) {
                    this.curve.offsetCurve(this.selected, offset_x, offset_y);
            ...
            //
                ...
                if (isInteger(this.selected)) {
                    ...
                    this.curve.offsetPoint(this.selected, offset_x, offset_y);
                    ...
                    if (!point.controller) {
                        if (this.selected > 0) {
                            this.curve.offsetPoint(this.selected -1, offset_x, offset_y);
                        }
