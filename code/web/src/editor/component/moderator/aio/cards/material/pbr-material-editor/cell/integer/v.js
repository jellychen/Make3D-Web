...
const tagName = 'x-biz-material-editor-integer';

/**
 * 调整整数
 */
export default class MaterialEditorInteger extends Element {
    /**
     * 元素
     */
    #name;
...
CustomElementRegister(tagName, MaterialEditorInteger);