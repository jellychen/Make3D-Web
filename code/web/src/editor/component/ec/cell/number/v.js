...
const tagName = 'x-biz-ec-cell-number';
...
export default class Number extends Element {
    ...
    attributeChangedCallback(name, _old, _new) {
        ...
        if ('name-token' == name) {
            ...
            this.setSpan(parseInt(_new));
        } else if ('one-span-subdivide' == name) {
            this.setOneSpanSubdivide(parseInt(_new));
        } else if ('integer' == name) {
            this.#numizer.setForceInteger('true' == _new);
        } else if ('scale' == name) {
            this.#numizer.setValueScale(parseFloat(_new));
        }
    }
