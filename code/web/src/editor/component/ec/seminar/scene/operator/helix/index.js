...
export default class Helix extends Base {
    ...
    start() {
        ...
        this.#setter.setMalposition(DEFAULT_MALPOSITION);
        ...
        this.#mesh.setName(`Helix - ${this.unique_id}`);
    ...
    resetToDefault() {
        if (this.#r0             == DEFAULT_R0 &&
            this.#r1             == DEFAULT_R1 &&
            this.#malposition    == DEFAULT_MALPOSITION &&
            this.#n_subdivisions == DEFAULT_SUBDIVISIONS &&
            this.#n_steps        == DEFAULT_STEPS &&
     ...
     * @param {*} angle_end 
     */
    #updateGeo(r0, r1, malposition, n_subdivisions, n_steps, angle_start, angle_end) {
        if (this.#r0             == r0 &&
            this.#r1             == r1 &&
        ...
        GeoSolidSoupEmbeddedShapes.Helix(
            soup.getPtr(), 
            r0, 
            r1, 
            malposition, 
