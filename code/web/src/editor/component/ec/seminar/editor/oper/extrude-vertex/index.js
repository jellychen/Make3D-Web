 ...
 * 挤出
 */
export default class ExtrudeVertex extends Base {
    /**
     * Wasm 对象链接
     */
    #connector;
    ...
    constructor(coordinator, arena, connector, host) {
        ...
        this.#connector_biz_controller = this.#connector.getManipulatorExtrudeVertex();
        if (!this.#connector_biz_controller) {
            throw new Error("getManipulatorExtrudeVertex error !!!");
        }
    ...
    #updateHaft() {
        ...
        if (0 == count) {
            ...
            this.#mat3_0.setFromMatrix4(matrix);
            this.#vec3_0.applyNormalMatrix(this.#mat3_0).normalize();
