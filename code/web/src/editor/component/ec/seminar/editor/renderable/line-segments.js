...
import LineMaterial from '@xthree/material/line-colorfull';
...
export default class LineSegments extends XThree.LineSegments {
    ...
    constructor(vertices, vertices_status) {
        ...
        this.material.setColor(Constants.COLOR_LINE_SEGMENT_NORMAL);
        this.material.setColorHighlight(Constants.COLOR_LINE_SEGMENT_HIGHLIGHT);
