 ...
 * NormalOffset
 */
export default class NormalOffset extends Base {
    /**
     * 设置面板
     */
    #setter;
    ...
    #onSetterChanged() {
        ...
        const {
            GeoSolidSoupOP,
            GeoSolidSoupOP_NormalOffsetContext,
        } = Chameleon;
        ...
        if (!this.#soup_current) {
            ...
            this.#op_context = new GeoSolidSoupOP_NormalOffsetContext(this.#soup_current);
            this.#op.normalOffset(0, this.#op_context);
        }

        // 执行修改
        this.#op_context.setOffset(parseFloat(this.#setter.offset));
